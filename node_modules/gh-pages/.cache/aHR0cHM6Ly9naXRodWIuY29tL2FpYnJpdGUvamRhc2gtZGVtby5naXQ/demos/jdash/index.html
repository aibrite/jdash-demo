...
<head>
    ...
    <!--removeIf(noprod)-->
    <script src="../../../lib/jdash-ui/dist/jdash.min.js"></script>
    <link rel="import" href="../../../lib/jdash-ui/dist/components/jdash.html">
    <!--endRemoveIf(noprod)-->
    ...
    <script>
        window.demoDashboardType = "jdash";
...
<body class="j-light-grey j-animate-opacity" style="display: none">
    ...
    <nav class="j-sidenav j-white j-animate-left" style="z-index:3;width:300px;display:none" id="mySidenav"><br>
        ...
        <div class="j-section j-padding-top ">
            <a target="_blank" href="http://facebook.com/jdash.io" class="j-hover-white j-hover-text-indigo j-show-inline-block"><i class="fa fa-facebook-official"></i></a>
